...
export default function ClaimsOrganize({ run, reload }: { run: ClaimsRunDetail; reload: () => Promise<void> }) {
  ...
  const organizationEditable = run.status === "map_ready";
